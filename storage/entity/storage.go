...
type (
	...
	EntityLister interface {
		List(string, *[]models.Entity) error
	}
...
// Adapter reader
func (p *Adapter) Read(name string, identifier string, c *models.Entity) (err error) {
...
// Adapter list
func (p *Adapter) List(name string, list *[]models.Entity) (err error) {
