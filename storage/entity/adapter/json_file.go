...
func (jc *JSONCodec) Read(entityName string, identifier string, candidate *models.Entity) (err error) {
...
func (jc *JSONCodec) List(entityName string, list *[]models.Entity) (err error) {
...
func warkpath(jc *JSONCodec, entityName string, ext string, list *[]models.Entity, path string, info fs.DirEntry, err error) error {
	if err != nil {
		return err
	}
